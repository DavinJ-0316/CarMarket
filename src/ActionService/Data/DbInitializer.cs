...
{
    // static enables other class to use InitDb method without instantiate DbInitializer
    public static void InitDb(WebApplication app) {
        // using keyword to dispose all services used inside after InitDb() have finished
    ...
    {
        // similar to the command line instruction: 
        // command to create migration: (只是初始化工程文件)
        // dotnet ef migrations add "InitialCreate" -o Data/Migrations

        // start posgresql by docker
        ...
        context.AddRange(auctions); // cahce to memory
